...
from genesis2.api import ComponentManager
from genesis2.config import Config
from genesis2.middleware import Application, AppDispatcher
from genesis2.framework.plugmgr import PluginLoader
...
def run_server(log_level=logging.INFO, config_file=''):
    ...
    # Register permanent app
    PluginLoader.register_mgr(app)
